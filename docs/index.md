...
| 🎨 **[Framer Motion Bible](./framer-motion/01-core-concepts/01-declarative-animation-philosophy.md)** | UI & Motion | 60FPS Layout Animations, AnimatePresence, Gestures, Scroll Progress |
